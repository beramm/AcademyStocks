...
struct BeachListItem: View {
    ...
    var body: some View {
        HStack {
            ...
            BeachChart(chartColor: (Color(red: 239/255, green:107/255, blue:13/255)), width: 120, height: 50, currentHeight: currentWaveHeight,showAxis: false, Data: filterBeachData(item, for: currDate),currentHour: Double(Calendar.current.component(.hour, from: .now)),isShowRuleMark: false)
